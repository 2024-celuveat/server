...
interface HelpfulReviewJpaEntityRepository : JpaRepository<HelpfulReviewJpaEntity, Long> {
    ...
    fun existsByReviewIdAndClickerId(reviewId: Long, clickerId: Long): Boolean

    fun findByClickerIdAndReviewId(memberId: Long, reviewId: Long): HelpfulReviewJpaEntity?

    fun getByClickerIdAndReviewId(memberId: Long, reviewId: Long): HelpfulReviewJpaEntity {
